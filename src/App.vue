...
<template>
  <div class="container">
    ...
    <form @submit.prevent="cadastraTarefa">
      <div class="row">
        <div class="col">
          <input :value="tarefaTemp" type="text" placeholder="Digite aqui a descrição da tarefa" class="form-control" required @change="evento => estado.tarefaTemp = evento.target.value">
        </div>
        <div class="col-md-2">
